...
function quran() {
  return [
    {
      name: "إِنَّمَا هَذِهِ الْحَيَاةُ الدُّنْيَا مَتَاعٌ",
      cover:
    ...
    {
      name: "كَلَّا إِنَّ الْإِنسَانَ لَيَطْغَىٰ",
      cover:
        "https://img.freepik.com/free-vector/arabic-background-with-mosque-silhouette-against-night-sky_1048-14082.jpg",
      artist: "القارئ محمد صديق المنشاوي",
      audio:
    ...
    },
    {
      ...
      cover:
        "https://img.freepik.com/free-vector/night-city-background-with-muslim-mosque_1441-2606.jpg?w=2000",
      artist: "القارئ محمد صديق المنشاوي",
      audio:
